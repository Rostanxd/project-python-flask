...
def user_factory(client):
    def _create_user(username: str, email: str, status: UserStatusEnum, password: str = "testpass123"):
...
def inactive_user(user_factory):
    return user_factory("inactive_user", "inactive@example.test", UserStatusEnum.INACTIVE)
